...
Nesta pasta estão simulações que podem ser feitas em ambiente Linux ou no [GitHub Codespaces](https://codespaces.new/menotti/mm). As turmas da disciplina precisam entregar as simulações a partir do [Classroom 50](https://classroom50.org/) usando os links postados no AVA. 
