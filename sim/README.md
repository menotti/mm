...
Nesta pasta estão simulações que podem ser feitas em ambiente Linux ou no [GitHub Codespaces](https://codespaces.new/menotti/mm). As turmas da disciplina precisam entregar as simulações a partir do [GitHub Classroom](https://classroom.github.com/) usando os links postados no AVA. 
